...
## Project Structure
    ...
    ├── testapiautostorybo_110117  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_110117`
...
2. Clone this repo and `cd testapiautostorybo_110117`
